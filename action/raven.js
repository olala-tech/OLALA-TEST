...
// Extended text message (quoted messages)
        ...
        notificationText += ` Delete Content: ${messageText}`;
        await client.sendMessage(client.user.id, { text: notificationText });
      }
...
contextInfo: {
          ...
          body: `DELETED MEDIA: ${deletedByFormatted}`,
          thumbnailUrl: "https://files.catbox.moe/hbo2oj.jpg",
          sourceUrl: '',
          mediaType: 1,
...
//========================================================================================================================//	  
 ...
 client.sendMessage(m.chat, { 
             ...
             }).then(() => client.sendMessage(m.chat, {text:`Hey @${kid.split("@")[0]}👋\n\nNo links allowed here, create your group to send links!`, contextInfo:{mentionedJid:[kid]}}, {quoted:m})); 
       }   
//========================================================================================================================//
if (antilinkall === 'on' && body.includes('https://') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, { 
             ...
             }).then(() => client.sendMessage(m.chat, {text:`hey @${ki.split("@")[0]}👋\n\nNo links are allowed in here, create your group to send your links!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m})); 
       }   
...
//========================================================================================================================//		      
 ...
 await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: " DOWNLOADED BY OLALA XMD BOT",
        },
        { quoted: m }
      );
      return;
...
//========================================================================================================================//		      
        ...
        async function redeployApp() {
            try {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of Princess Ruby Bot unleashed upon you.");
...
await client.sendMessage(
                m.chat,
                {
                  ...
                  mimetype: "audio/mp3",
		  caption: "DOWNLOADED BY OLALA XMD",
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY OLALA XMD`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	case 'leaves': {		     
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves OLALA XMD");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {		      
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena OLALA XMD");
      return;
    }
	try {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗣𝗿𝗶𝗻𝗰𝗲𝘀𝘀 𝗥𝘂𝗯𝘆 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
...
if (!/image|pdf/.test(mime)) return m.reply("That is not an image, try again while quoting an actual image.");             
                    ...
                    m.reply(`𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗥𝗮𝘃𝗲𝗻[𝗣𝗿𝗶𝗻𝗰𝗲𝘀𝘀 𝗥𝘂𝗯𝘆-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 ${mime.includes("pdf") ? "𝗣𝗗𝗙" : "𝗜𝗺𝗮𝗴𝗲"} . . .`);
...
//========================================================================================================================//		      
	      case "vision": {
		      if (!msgR || !text) {
    m.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 OLALA XMD 𝗔𝗶, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    return;
  }
  ;
  let _0x44b3e0;
...
case "kill": case "kickall": {
      ...
      await client.groupUpdateDescription(m.chat, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 OLALA DEV !");
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 OLALA DEV !");
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 OLALA XMD`}, { quoted: m}) 
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/hbo2oj.jpg' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: OLALA XMD*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝗠𝗭𝗔𝗭𝗜*\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: 𝗠𝗭𝗔𝗭𝗜-𝗧𝗘𝗖𝗛`}); 
 break;
...
case "faker": {
    ...
    if (!args || !args[0]) {
      ...
      let _0x2d7d67 = `OLALA 𝚑𝚊𝚜 𝚍𝚎𝚝𝚎𝚌𝚝𝚎𝚍 𝚝𝚑𝚎 𝚏𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 ${_0x2f8982.length} 𝙵𝚊𝚔𝚎 𝚊𝚌𝚌𝚘𝚞𝚗𝚝𝚜 𝚒𝚗 𝚝𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙:- \n`;
      for (let _0x28761c of _0x2f8982) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝙽𝚘𝚠 OLALA 𝚠𝚒𝚕𝚕 𝚛𝚎𝚖𝚘𝚟𝚎 ${_0x2f8982.length} 𝙵𝚊𝚔𝚎 𝙰𝚌𝚌𝚘𝚞𝚗𝚝𝚜 𝚏𝚛𝚘𝚖 𝚝𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙.\n\n𝙶𝚘𝚘𝚍𝚋𝚢𝚎👋 𝙵𝚊𝚔𝚎 𝚙𝚎𝚘𝚙𝚕𝚎.`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
await client.sendMessage(m.chat, { image: { url: imagelink}, caption: "Converted by OLALA! 🦄"}, { quoted: m});
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 OLALA XMD:*\n\n';  
...
if (users == "254798956113@s.whatsapp.net") return m.reply("It's an Owner Number! 😡");
...
try {
        ...
        const capp = `DOWNLOADED BY OLALA XMD`;
...
//========================================================================================================================//
		      case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    const close = `GROUP HAS BEEN CLOSED BY OLALA XMD`
...
//========================================================================================================================//		      
		      case 'opentime':
                ...
                setTimeout(() => {
                    var nomor = m.participant
                    const open = `GROUP HAS BEEN OPENED BY OLALA XMD`
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : 'GOODBYE,OLALA XMD IS LEAVING NOW,ENJOY YOUR GROUP, I WILL BE BACK LATER' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(m.chat, { image: { url: imageUrl }, caption: `RETRIEVED BY OLALA XMD!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(m.chat, { video: { url: videoUrl }, caption: `RETRIEVED BY OLALA XMD!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
if (!m.quoted) return m.reply("Hurrahhh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `RETRIEVED BY OLALA XMD!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(client.user.id, { video: { url: videoUrl }, caption: `RETRIEVED BY OLALA XMD!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
                ...
                client.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'OLALA XMD',
                            body: 'https://github.com/OLALA-TECH/OLALA XMD',
                            thumbnailUrl: 'https://files.catbox.moe/5l8xct.jpg',
                            sourceUrl: 'https://github.com/OLALA-TECH/OLALA XMD',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `CONVERTRD BY OLALA XMD`}, { quoted: m }) 
...
//========================================================================================================================//		      
         ...
         for (let i of res) { 
             let txt = `OLALA XMD BOT BROADCAST\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}` 
...
//========================================================================================================================//		      
 case "gemini": {
    try {
        if (!text) return m.reply("This is OALA XMD, an AI using Gemini APIs to process text, provide yr query");
...
case "block": { 
 ...
 let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
	 if (users == "254798956113@s.whatsapp.net") return m.reply("𝗜 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗹𝗼𝗰𝗸 𝗺𝘆 𝗢𝘄𝗻𝗲𝗿 😡");
...
try {
        ...
        pp = 'https://files.catbox.moe/hbo2oj.jpg';
      }
